        ...
        <article id="main">
            <div className="nav">
                <nav className="nav-inner">
                    <a id="nav1" className="nav-link" href="#top">top</a>
                    <a id="nav1_5" className="nav-link" href="#bio">bio</a>
                    <a id="nav2" className="nav-link" href="#cc">cc</a>
                    <a id="nav3" className="nav-link" href="#bike">bike</a>
                    <a id="nav4" className="nav-link" href="#petshop">petshop</a>
                    <a id="nav5" className="nav-link" href="#danvc">danvc</a>
                    <a id="nav6" className="nav-link" href="#koiryu">koiryu</a>
                    <a id="nav7" className="nav-link" href="#miicoro">miicoro</a>
                    <a id="nav8" className="nav-link" href="#parkingreserve">parkingreserve</a>
                </nav>
            </div>
                ...
                <div className="mainblocksection bg-black">
                    <section className="biosection">
                        ...
                        <section className="biosections text-white">
                            ...
                            <li>他社ウェブサイトのCMSによる構築製作、修正　webデザイン　HTMLコーディング</li>
                            <li>サイトテーマのもととなるWebページ作成</li>
                            <li>他社サイトのCMSによる製作</li>
                            <li>テスト環境をMAC, APACHE, MySQL, PHPにより構築、WORDPRESSでサイト構築し、PHPサイトテーマをコーディング（HTML,CSS,PHP）。
                                <br/>のちに本サーバに移行（移行時にURLが変わるのでMySQLの編集を行う）
                            </li>
                        </section>
                        <section className="biosections text-white">
                            <h3>【webデザイン　HTMLコーディング】</h3>
                        ...
                        <section className="biosections text-white">
                            ...
                            <li>担当フェーズ：キャラクター、パーツ、サイトの画像処理、送信フォーム作成</li>
                        ...
                        <section className="biosections text-white">
                            ...
                            <li>AngularJS bootstrap Javascript HTML5 CSS3 LESS VSCode Protractor SVN</li>
                        </section>
                        <section className="biosections text-white">
                            <h3>【Swift開発 サイト制作】</h3>
            ...
            <div id="heading1" className="mainblock sticky heading">
                ...
                <section className="mainblocksection">
                    <h2>デザイン実績、作品紹介 <br/>(リンク先に制作物あり)</h2>
                </section>
            </div>
                ...
                <div className="mainblocksection bg-white">
                    <section className="tilesection appear-totop text-black">
                        ...
                        <h3 className="sakuhinh3">
                            <a href="cc/" target="_new">小売サイト（自家焙煎コーヒー）</a>
                        </h3>
                        <p>トップ画像は、背景（白）を右上に行くに従い透明になるようにPhotoshopで加工し、CSSで背景を茶色系に指定することで茶色系の背景が左下に行くに従って白くなるように。</p>
                        <p>中央画像は、左に行くに従い透明になるようPhotoshopで加工。</p>
                        <p>ナビゲーションバーは、マウスを乗せると字が大きくなるようにCSSで指定し、サイドバーはマウスを乗せると茶色の背景が白くなり、文字の色が黒に反転。</p>
                        <p>なおかつマウスで押下すると数px右下にずれる、周りの影が反転することで、ボタンが画面の中へ入っていくかのようにみせるようCSSで指定。</p>
                    </section>
                </div>
            </div>
            <div id="bike" className="mainblock sticky performance2">
                ...
                <div className="mainblocksection">
                    <section className="tilesection appear-totop text-white">
                        ...
                        <h3 className="sakuhinh3">
                            <a href="bike/" target="_new">中古バイク引き取りサイト</a>　(選考のため制作物)
                        </h3>
                        <p>バイク画像、数字の画像、日本地図の画像は、元あったクライアント様のものから使わせていただきました。</p>
                        <p>トップバナー画像</p>
                        <p>バイクの画像は、元あったクライアント様のものを加工をPhotoshopで加工。</p>
                        <p>女性の３D画像は、POSERで制作。ロゴもPhotoshopで作成。</p>
                        <p>それらをPhotoshop上で配置、テキストを加え一枚のバナーにしました。</p>
            ...
            <div id="petshop" className="mainblock sticky performance3">
                <div className="mainblocksection bg-white">
                    <section className="tilesection appear-totop text-black">
                        ...
                        <h3 className="sakuhinh3">
                            <a href="petshop/" target="_new">ペットショップサイト</a>　(個人の制作物)
                        </h3>
                        <p>navbarをjavascript(jquery)でレスポンシブ</p>
                        <p>足跡の画像は、ネットからひっぱってきた物をillustlatorで加工</p>
                        <p>また、写真以外の画像はゼロからphotoshopで制作</p>
                        <p>キャラクターは、illustlatorで制作したオリジナルキャラクターです。</p>
                        <p>ナビゲーションバーのボタンは、CSS3で画像切り替えで実装、メインコンテンツの『一覧へ』ボタンのデザインと動作はCSS3のみで実装</p>
                    </section>
                </div>
            </div>
            <div id="danvc" className="mainblock sticky performance4">
                <div className="mainblocksection bg-white">
                    <section className="tilesection-white appear-totop text-black">
                        ...
                        <h3 className="sakuhinh3">
                            <a href="http://danvc.com" target="_new">ベンチャーキャピタル</a>
                        </h3>
                        <p>２０１５年６月サイトを制作しました</p>
                        <p>すでにできているデザインをもとに、デザイン修正及びコーディング</p>
                        <p>レスポンシブサイトです。</p>
                        <p>トップへ戻るボタン、画像のグレイ表示をjavascript(jquery)で実装</p>
            ...
            <div id="koiryu" className="mainblock sticky performance5">
                <div className="mainblocksection">
                    <section className="tilesection appear-totop text-white">
                        <a className="imglink" href="http://frankart.jp/koiryu/" target="_new">
                            <img className="site-img" src={ Kiryu } />
                        </a>
                        <h3 className="sakuhinh3">
                            <a href="http://frankart.jp/koiryu/" target="_new">ゲームアプリ画像処理</a>
                        </h3>
                        <p>担当フェーズ：キャラクター、パーツ、サイトの画像処理、送信フォーム作成</p>
                        <p>キャラクター衣装加工、ロゴ加工、セリフ背景加工、サイトの画像処理、送信フォーム作成</p>
                    </section>
                </div>
            </div>
            <div id="miicoro" className="mainblock sticky performance6">
                <div className="mainblocksection bg-white">
                    <section className="tilesection appear-totop text-black">
                        <a className="imglink" href="https://store.line.me/stickershop/product/1476806/ja" target="_new">
                            <img className="site-img" src={ Mc1040hw } />
                        </a>
                        <h3 className="sakuhinh3">
                            <a href="https://store.line.me/stickershop/product/1476806/ja" target="_new">LINEスタンプ制作</a>
                        </h3>
            ...
            <div id="parkingreserve" className="mainblock sticky performance7">
                <div className="mainblocksection bg-black">
                    <section className="tilesection appear-totop text-white">
                        ...
                        <h3 className="sakuhinh3">
                            空港駐車場予約サービス<br/> https://itami.reserve.parkingweb.jp
                        </h3>
